...
public class Ex12_06_김용주 extends Frame implements ItemListener{
	String [] daruk = {"아시아","유럽","아프리카"};
	String [][] country = {{"한국","일본","중국"},
			{"영국","스위스","프랑스"},
			{"이집트","콩고","우간다"}
			};
	...
	Label beup = new Label("대륙과 나라를 선택하세요");
